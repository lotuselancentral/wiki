<?php
/**
 * WikiLEC, based on MonoBook nouveau
 *
 ...
 * @subpackage Skins
 */
class SkinWikiLEC extends SkinTemplate {
	/** Using monobook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'wikilec';
		$this->stylename = 'wikilec';
		$this->template  = 'WikiLECTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class WikiLECTemplate extends QuickTemplate {
	/**
...
<?php	}
	...
	<meta name="verify-v1" content="qMnDWTJjy9pGS+R74d7SFyYe4gcsi30+FTT3cNY3r0s=" />
	</head>
